<template>
	<el-container style="background-color: #755854">
		<el-header class="homeHeader nav">
			<div class="title" style="color: #58636b">后台管理系统</div>
			...
			<el-aside width="200px" style="margin-left: -9px" default-active="2" class="el-menu-vertical-demo">
				...
				<el-menu router style="height: 100%" background-color="#545c64"
					...
					<el-submenu :index="index+''" v-for="(item,index) in routes" v-if="!item.hidden"
						...
						<!--<el-menu-item style="min-width: 179px" :index="children.path"-->
						<!--			  v-for="(children,indexj) in item.children"-->
					...
					<el-row :gutter="20">
						...
						<el-col :span="6">
							<div class="grid-content bg-purple">
								<div id="myPieChart"
									 :style="{top:'50px',left:'1282px', width: '450px', height: '400px'}"></div>
							</div>
						</el-col>
						<el-col :span="6">
							<div class="grid-content bg-purple mapMaxMin"
								 style="box-shadow: rgb(-4 6 -3 / 54%) 0px 2px 17px 6px">
								<div id="myHeatMap" class="myHeatMap"
									 :style="{top:'0', width: '2300px', height: '600px'}"></div>
							</div>
						</el-col>
					</el-row>
